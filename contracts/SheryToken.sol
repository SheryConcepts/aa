...
contract SheryToken is ERC20, Ownable {
    ...
    constructor(string memory sheryToken, string memory ST)
        ERC20(sheryToken, ST)
    {
    ...
    function mint(address to, uint256 amount) public {
        // << Removed the onlyOwner Modifier to everybody can try
        _mint(to, amount);
    }
    ...
    function faucet() external {
        ...
        require(
            addressTime[msg.sender] < block.timestamp,
